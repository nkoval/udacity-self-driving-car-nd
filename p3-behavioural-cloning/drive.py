...
def telemetry(sid, data):
    ...
    steering_angle = int(model.predict(process_images(transformed_image_array), batch_size=1))
    steering_angle /= 100

    steering_angle *= 3

    throttle = max(0.05, -1.5 * abs(steering_angle) + 0.2)
